...
var fract=(function (){
	...
	module.help =(function(){
		var module={},
			...
			current = controlbox;
		module.toggle = function(){
			var controlbox = controlbox || document.getElementById("hjälpbox");
			if (controlbox.className == "hjälpbox" ) {
				controlbox.className = "hidden";
			}
			else {
				controlbox.className = "hjälpbox";
			}
			module.show("default");
		}
	...
	var makeThumb = function(spec){
		...
		c.onmouseout=function (){over=false; outward.render(); fract.help.show("default");};
		
		d.onmouseover=function (){fract.help.show(outward.id);};
		d.onmouseout=function (){fract.help.show("default");};
