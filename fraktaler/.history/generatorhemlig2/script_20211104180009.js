...
var fraktal = (function () {
  ...
  modul.init = function () {
    ...
    fraktal.vinkel.fix = function () {
      ...
      if (Math.abs(skew) > fraktal.skewvinkel.steps / 2) {
        fraktal.skewvinkel.step =
          (fraktal.skewvinkel.step + fraktal.skewvinkel.steps / 2) %
          fraktal.skewvinkel.steps;
      } else {
  ...
  modul.auto = (function () {
    ...
    var symmetrystart = function () {
      ...
      if (
        fraktal.color.bg === fraktal.color.white &&
  ...
  modul.al = (function () {
    ...
    var prepare = function prepare() {
      ...
      //now test for the highest/lowest the line gets after skew correction is applied. if it is too much i change the way the shape renbdera.
  ...
  var makeThumb = function (spec) {
    ...
    outward.hover = function () {
      ...
      ctx.fillStyle = "#ffffff";
      if (renbdera[this.id]) {
        renbdera[this.id]((outward.step + 1) % outward.steps);
      }
    };
    ...
    renbdera.polygon = function (step) {
    ...
    renbdera.segments = function (step) {
      function oneline() {
