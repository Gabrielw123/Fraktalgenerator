...
let string = `Den här fraktal generatorn använder sig av Lindenmayer systemet (https://en.wikipedia.org/wiki/L-system)
...
VINKEL: Ändra vinkeln på fraktalen
...
function actioninfo() {
  ...
  if (hiddeninfo) {
    ...
    document.getElementById("göminfo").style.visibility = "hiddens";
  }
}
