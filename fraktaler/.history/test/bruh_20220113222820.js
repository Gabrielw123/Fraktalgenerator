...
ANIMERA: 
SPARA: 
RESET: reseta till start fraktalen
EXEMPEL: för att visa exempel på fraktaler: OBS: tryck på DJUP efter att du har valt ett exemepel

TUTORIAL:
1. Börja med att trycka på DJUP 
2. 
3. 
4. 
5.`;
