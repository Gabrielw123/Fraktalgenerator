...
btn.addEventListener("click", function () {
  ...
  var rules2 = document.getElementById("rules").value;
  alert("axiom: " + axiom2 + "    rules: " + rules2);
  axiom = axiom2;
  rules = [
    {
      in: "F",
...
function drawGUI() {
  ...
  genButton.mousePressed(function () {
    ...
    var rulesout = document.getElementById("rules-out");
    rulesout.innerHTML = rules;
    update();
  });
}
